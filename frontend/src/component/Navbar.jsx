  ...
  const element =
    (
      <div className="text-lg md:flex-grow">
        ...
        <Link to="/teams/" className="block mt-4 md:inline-block md:mt-0 text-white hover:text-green-200 mr-4">
          Teams
        </Link>
        <Link to="/projects/" className="block mt-4 md:inline-block md:mt-0 text-white hover:text-green-200 mr-4">
          Projects
        </Link>
        <Link to="/leave/" className="block mt-4 md:inline-block md:mt-0 text-white hover:text-green-200 mr-4">
          Leave
        </Link>
        <Link to="/category/" className="block mt-4 md:inline-block md:mt-0 text-white hover:text-green-200">
          Category
        </Link>
